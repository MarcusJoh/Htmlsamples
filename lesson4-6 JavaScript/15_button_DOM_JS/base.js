...
function buttonCount() {
	...
	var allEleWithHide = document.getElementsByClassName("hide");
	// this is now an arrey with all of the html that has that class

	// loop through the arrey
	for (var i = 0; i < allEleWithHide.length; i++) {
...
function showToggle() {
	...
	var divEle = document.getElementById("toggleDiv");
